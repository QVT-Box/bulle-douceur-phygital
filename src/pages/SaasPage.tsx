      ...
      <div className="relative z-10 pt-24 px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-foreground/70 mb-16 max-w-3xl mx-auto">
            Découvrez notre plateforme RH bienveillante pour accompagner vos équipes
          </p>
          
          <div className="text-center py-20">
            <div className="w-24 h-24 rounded-full bg-gradient-bubble mx-auto mb-8 animate-float"></div>
            <h2 className="text-2xl font-kalam font-bold text-secondary mb-4">
              Page en construction
            </h2>
            <p className="text-foreground/70">
              La démonstration complète arrive bientôt !
            </p>
          </div>
        </div>
      </div>
