...
import { Phone, Mail, MapPin, MessageCircle, Send, Building2, Users, BarChart3 } from "lucide-react";
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <Button 
                      ...
                      variant="outline"
                      className="flex-1"
                      onClick={() => setFormData({...formData, type_offre: 'licence-saas', message: 'Je souhaite recevoir une démonstration de la licence SaaS QVT Box pour mon entreprise.'})}
                    >
