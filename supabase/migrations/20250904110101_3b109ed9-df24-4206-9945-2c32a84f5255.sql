-- Add RLS policies and functions for CMS system - Fixed
...
('content.ocde_message', '"Nous privilégions le Made in France et les producteurs locaux."', 'Message OCDE personnalisable'),
